...
def load_inference_source(source=None, imgsz=640, vid_stride=1, spectrum='visible'):
    """
    ...
    Args:
        ...
        spectrum (str, required): selection between visible or thermal spectrum
    ...
    if tensor:
        ...
        dataset = LoadStreams(source, imgsz=imgsz, vid_stride=vid_stride, spectrum=spectrum)
    elif screenshot:
